      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full p-4 bg-gray-100 rounded-lg outline-none border-2 transition-colors ${
              errors.name
                ? "border-red-400"
        ...
        <div>
          ...
          <textarea
            ...
            className={`w-full p-4 bg-gray-100 rounded-lg outline-none border-2 transition-colors resize-none ${
              errors.message
                ? "border-red-400"
                : "border-transparent focus:border-blue-400"
            }`}
        ...
        <button
          ...
          className="w-full bg-theme-primary hover:bg-blue-600/90 text-white font-bold py-3 sm:py-4 rounded-lg transition-all "
        >
