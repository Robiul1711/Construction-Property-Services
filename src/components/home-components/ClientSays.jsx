...
const ClientSays = () => {
  ...
  return (
    <div className="section-padding-x py-6 md:py-12">
      {/* Header */}
      ...
      <div className="relative">
        <div className="bg-[#F9F9F9] rounded-2xl p-8 md:p-12 lg:p-16">
          <div className="items-center flex flex-col md:flex-row gap-6">
            {/* Left Side - Progress Bar and Content */}
            <div className="relative">
              ...
              <div className="md:pl-8 lg:pl-12">
                ...
                <div className="flex gap-3">
                  <button
                    onClick={handlePrev}
                    className="swiper-prev w-12 h-12 rounded-full border border-gray-300 flex items-center justify-center hover:bg-[#131313] hover:text-white transition-all duration-200 ease-in-out cursor-pointer"
                  >
                    <ChevronLeft />
                  </button>
                  <button
